...
int main(void)
{
	...
	printf("TEST FLAG MINUS + HP + FLAG +\n");
	t = printf("o15 = |%+-d|\n", z);
	t1 = ft_printf("m15 = |%+-d|\n", z);
	printf("o15 = %d\n",t);
	printf("m15 = %d\n",t1);
	...
	printf("TEST FLAG MINUS + HP + T + FLAG +\n");
	...
	printf("TEST FLAG MINUS + HP + FLAG SPASE\n");
	t = printf("o23 = |%- d|\n", z);
	t1 = ft_printf("m23 = |%- d|\n", z);
	printf("o23 = %d\n",t);
	printf("m23 = %d\n",t1);
	...
	printf("TEST FLAG MINUS + T + FLAG SPASE\n");
	t = printf("o26 = |%- .d|\n", z);
	t1 = ft_printf("m26 = |%- .d|\n", z);
	printf("o26 = %d\n",t);
	printf("m26 = %d\n",t1);
	...
	printf("TEST FLAG MINUS + HP + T + FLAG SPASE\n");
