...
/*   Updated: 2019/02/09 17:39:46 by agottlie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//Presicions for wide strings	
	...
	printf("   |i|:\n");
	// PRINTF("\t|%12i|\t|%12i|\t|%12i|", INT_MIN, INT_MAX,0);			vot
	// PRINTF("\t|%012i|\t|%-12i|\t|%012i|",-42,42,42);			vot
	printf("\n   |d|:\n");
	// PRINTF("\t|%12d|\t|%12d|\t|%12d|", INT_MIN, INT_MAX,0);			vot
	// PRINTF("\t|%012d|\t|%-12d|\t|%012d|",-42,42,42);			vot
	printf("\n   |D|:\n");
	// PRINTF("\t|%12D|\t|%12D|\t|%12D|", INT_MIN, INT_MAX,0);
	// PRINTF("\t|%012D|\t|%-12D|\t|%012D|",-42,42,42);
	printf("\n   |u|:\n");
	// PRINTF("\t|%12u|\t|%12u|\t|%12u|", INT_MIN, INT_MAX,0);			vot
	// PRINTF("\t|%012u|\t|%-12u|\t|%012u|",-42,42,42);			vot
	// printf("\n   |U|:\n");
	// PRINTF("\t|%12U|\t|%12U|\t|%12U|", INT_MIN, INT_MAX,0);
	// PRINTF("\t|%012U|\t|%-12U|\t|%012U|",-42,42,42);
	// printf("\n   |o|:\n");		// chotko
	// PRINTF("\t|%12o|\t|%12o|\t|%12o|", INT_MIN, INT_MAX,0);		// chotko
	// PRINTF("\t|%012o|\t|%-12o|\t|%012o|",-42,42,42);		// chotko
	// printf("\n   |O|:\n");
	// PRINTF("\t|%12O|\t|%12O|\t|%12O|", INT_MIN, INT_MAX,0);
	// PRINTF("\t|%012O|\t|%-12O|\t|%012O|",-42,42,42);
	// printf("\n   |x|:\n");		// chotko
	// PRINTF("\t|%12x|\t|%12x|\t|%12x|", INT_MIN, INT_MAX,0);		// chotko
	// PRINTF("\t|%012x|\t|%-12x|\t|%012x|",-42,42,42);		// chotko
	// printf("\n   |X|:\n");		// chotko
	// PRINTF("\t|%12X|\t|%12X|\t|%12X|", INT_MIN, INT_MAX,0);		// chotko
	// PRINTF("\t|%012X|\t|%-12X|\t|%012X|",-42,42,42);		// chotko
	TITLE("Number options(field width, presicion and -):\n");
	{
		...
		// #define CNV "i"
		// printf("\n   |"CNV"|:\n");
		// PRINTF("|%1.1"CNV"|\t\t|%5.1"CNV"|\t\t|%5.3"CNV"|\t\t|%1.5"CNV"|\t",nmb, nmb, nmb, nmb);	//vot
		// PRINTF("|%1.1"CNV"|\t\t|%5.1"CNV"|\t\t|%5.3"CNV"|\t\t|%1.5"CNV"|",-nmb, -nmb, -nmb, -nmb);	//vot
		// PRINTF("|%3.5"CNV"|\t\t|%3.5"CNV"|\t|%07.5"CNV"|\t|%07.5"CNV"|",nmb, -nmb, nmb, -nmb);	//vot
		// PRINTF("|%8.5"CNV"|\t|%8.5"CNV"|\t|%08"CNV"|\t|%08"CNV"|",nmb, -nmb, nmb, -nmb);	//vot
		...
		// PRINTF("|%."CNV" %.0"CNV" %0."CNV" %0.0"CNV"|\t\t|%"CNV" %.2"CNV" %2."CNV" %2.2"CNV"|\t\t\t\t",0,0,0,0,0,0,0,0); // vot
	}
	// {
		// int nmb = 4235;
		// #define CNV "d"
