...
/*   Updated: 2019/02/15 10:38:07 by yharwyn-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	}
	...
	printf("\t|%5s|\t|%5s|\t|%20s|\t|%20s|\t|%20s|\t|%10s|\t|%10s|\n", "hh", "h", "l", "ll","j", "z", "nothing" );
	{
		# define CNV "i"
		printf("\n   |"CNV"|:\n");
		PRINTF("|%5hh"CNV"|\t|%5h"CNV"|\t|%20l"CNV"|\t|%20ll"CNV"|%10"CNV"|", LONG_MAX,LONG_MAX,LONG_MAX,LONG_MAX,LONG_MAX,LONG_MAX);
		PRINTF("|%5hh"CNV"|\t|%5h"CNV"|\t|%20l"CNV"|\t|%20ll"CNV"|%10"CNV"|", LONG_MIN,LONG_MIN,LONG_MIN,LONG_MIN,LONG_MIN,LONG_MIN);
	}
// 	{
// 		# define CNV "d"
// 		printf("\n   |"CNV"|:\n");
